 ...
 * @author nik_3
 */
public class SimpleDashServlet extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        try (PrintWriter out = response.getWriter()) {
            ...
            request.getRequestDispatcher("Dashboard_Simple.jsp").forward(request, response);
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            Logger.getLogger(SimpleDashServlet.class.getName()).log(Level.SEVERE, null, ex);
        }
    }
